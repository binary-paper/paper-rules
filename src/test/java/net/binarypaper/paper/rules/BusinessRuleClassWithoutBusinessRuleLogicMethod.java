...
/**
 * A test business rule class without a method annotated with the
 * BusinessRuleLogic annotation.
 *
 * @author <a href="mailto:willy.gadney@binarypaper.net">Willy Gadney</a>
 */
@BusinessRuleTable
public class BusinessRuleClassWithoutBusinessRuleLogicMethod {
